                ...
                <Modal.Body>
                    <form className="row g-3">
                        ...
                        <div className='col-md-12'>
                            <label className='form-label label-upload' htmlFor='imgUpload' ><FaPlus /> Upload File Image</label>
                            <input onChange={(event) => handleUploadFile(event)} type='file' hidden id='imgUpload' />
                        </div>
